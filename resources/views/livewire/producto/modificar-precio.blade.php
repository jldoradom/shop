                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">@lang('web.seccion_modificar_productos')
                ...
                <div class="card-body">
                        <div class="mb-7">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-9 col-xl-3 mt-5">
                                    <div class="row align-items-center">
                                        @if($productos->count() and $fabricante_id !== '')
                                            <div class="col-md-12 my-2 my-md-0">
                                                <div class="form-group">
                                                    <label for="cantidadFabricante">@lang('web.descuento')</label>
                                                    <input type="text" wire:model='cantidadFabricante' id="cantidadFabricante" class="form-control
                                                        @error('cantidadFabricante') is-invalid @enderror" >
                                                    @error('cantidadFabricante')
                                                        <span class="text-red-600">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <button wire:click="modificarPrecioFabricante" class="btn btn-secondary">@lang('web.desactivar')</button>
                                                @if($volverAtrasFabricante)
                                                    <button wire:click="atrasPrecioFabricante" class="btn btn-secondary">@lang('web.atras')</button>
                                                @endif
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-lg-9 col-xl-3 mt-5">
                                    <div class="row align-items-center">
                                        @if($productos->count() and $categoria_id !== '')
                                            <div class="col-md-12 my-2 my-md-0">
                                                <div class="form-group">
                                                    <label for="cantidadCategoria">@lang('web.descuento')</label>
                                                    <input type="text" wire:model='cantidadCategoria' id="cantidadCategoria" class="form-control
                                                             @error('cantidadCategoria') is-invalid @enderror" >
                                                    @error('cantidadCategoria')
                                                        <span class="text-red-600">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <button wire:click="modificarPrecioCategoria" class="btn btn-secondary">@lang('web.desactivar_categoria')</button>
                                                @if($volverAtrasCategoria)
                                                    <button wire:click="atrasPrecioCategoria" class="btn btn-secondary">@lang('web.atras')</button>
                                                @endif
                                            </div>
                                        @endif
                                    </div>
