                                ...
                                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline"  role="grid" aria-describedby="" style="width: 1231px;">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable_2" rowspan="1" colspan="1" style="width: 65px;" aria-label="">Ref</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable_2" rowspan="1" colspan="1" style="width: 87px;" aria-label="">@lang('web.estado')</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable_2" rowspan="1" colspan="1" style="width: 87px;" aria-label="">@lang('web.pago')</th>
                                    ...
                                    @if($pedidos->count())
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td>{{ $pedido->id }}</td>
                                                <td>{{ $pedido->ref }}</td>
                                                <td><span class="label label-lg label-light-primary label-inline font-weight-bold py-4">{{ $pedido->total }}</span></td>
                                                <td>
                                                    @if($pedido->estado == 'proceso')
                                                        <span class="label label-primary label-dot mr-2"></span><span class="font-weight-bold text-primary">@lang('web.proceso')</span>
                                                    @elseif($pedido->estado == 'enviado')
                                                        <span class="label label-success label-dot mr-2"></span><span class="font-weight-bold text-success">@lang('web.enviado')</span>
                                                    @elseif($pedido->estado == 'completado')
                                                        <span class="label label-success label-dot mr-2"></span><span class="font-weight-bold text-success">@lang('web.completado')</span>
                                                    @elseif($pedido->estado == 'anulado')
                                                        <span class="label label-danger label-dot mr-2"></span><span class="font-weight-bold text-danger">@lang('web.anulado')</span>
                                                    @endif
                                                </td>
                                                <td>{{ $pedido->pago }}</td>
                                                <td nowrap="nowrap">
                                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2" title="Editar" wire:click="$emit('editar', {{$pedido->id}})">
                                                    ...
                                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Ver" wire:click="$emit('view', {{$pedido->id}})">
                                                    ...
                                                    @if($confirming===$pedido->id)
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Eliminar Definitívamente" wire:click="$emit('eliminar', {{$pedido->id}})">
                                                    ...
                                                    @else
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Eliminar pedido"  wire:click="confirmDelete({{ $pedido->id }})">
                                                    ...
                                                    @endif
                                                    @if($confiremail===$pedido->id)
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Enviar Definitívamente" wire:click="$emit('enviar', {{$pedido->id}})">
                                                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-09-29-132851/theme/html/demo1/dist/../src/media/svg/icons/Code/Done-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
                                                                    <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10"/>
                                                        ...
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="No Enviar" wire:click="noenviar()">
                                                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-09-29-132851/theme/html/demo1/dist/../src/media/svg/icons/Code/Error-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
                                                                    <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10"/>
                                                    ...
                                                    @else
                                                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Enviar email con el codigo de seguimiento"  wire:click="confirmEmail({{ $pedido->id }})">
                                                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-10-29-133027/theme/html/demo1/dist/../src/media/svg/icons/Communication/Mail.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"/>
